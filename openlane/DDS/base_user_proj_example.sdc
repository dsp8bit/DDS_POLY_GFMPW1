...
# Input delays
#set_input_delay -max 8 -clock [get_clocks {clk}] [get_ports {la_data_in[*]}]
...
set_input_transition -max 4.86  [get_ports {la_data_in[*]}]
...
set_input_delay -clock clk -max 9 [get_ports Enable]
set_input_delay -clock clk -max 9 [get_ports LoadP]
set_input_delay -clock clk -max 9 [get_ports LoadF]
set_input_delay -clock clk -max 9 [get_ports rst]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[0]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[1]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[2]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[3]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[4]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[5]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[6]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[7]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[8]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[9]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[10]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[11]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[12]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[13]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[14]]
set_input_delay -clock clk -max 9 [get_ports FreqPhase[15]]
# ... Repeat for other missing input ports ...

# Example of adding input delay constraints for the missing input ports with min delay
set_input_delay -clock clk -min 0.8 [get_ports Enable]
set_input_delay -clock clk -min 0.8 [get_ports LoadP]
set_input_delay -clock clk -min 0.8 [get_ports LoadF]
set_input_delay -clock clk -min 0.8 [get_ports rst]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[0]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[1]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[2]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[3]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[4]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[5]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[6]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[7]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[8]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[9]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[10]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[11]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[12]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[13]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[14]]
set_input_delay -clock clk -min 0.8 [get_ports FreqPhase[15]]

#output
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[0]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[1]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[2]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[3]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[4]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[5]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[6]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[7]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[8]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[9]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[10]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[11]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[12]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[13]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[14]]
set_output_delay -clock clk -min 0.8 [get_ports Cos_Out[15]]
#outputmax
set_output_delay -clock clk -max 8 [get_ports Cos_Out[0]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[1]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[2]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[3]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[4]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[5]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[6]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[7]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[8]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[9]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[10]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[11]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[12]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[13]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[14]]
set_output_delay -clock clk -max 8 [get_ports Cos_Out[15]]
